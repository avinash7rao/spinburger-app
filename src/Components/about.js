      ...
      <div id="about" className="tm-page-content">
        <div className="tm-black-bg tm-mb-20 tm-about-box-1">
          ...
          <div className="tm-list-item tm-list-item-2">
            <img
              src="https://cdn.glitch.me/1f754e20-cea6-4980-a548-b5284a0ba764%2Fannie-s-burger-shack.jpeg?v=1636460797423"
              alt="Image"
            ...
            <div className="tm-list-item-text-2">
              ...
              <p>
                ...
                paid for your website services. Please tell your friends about
                us.
              </p>
            </div>
          </div>
        ...
        <div className="tm-black-bg tm-mb-20 tm-about-box-2">
          <div className="tm-list-item tm-list-item-2">
            ...
            <img
              src="https://cdn.glitch.me/1f754e20-cea6-4980-a548-b5284a0ba764%2Fimage.jpeg?v=1636460803569"
              alt="Image"
          ...
          <p>
            ...
            finibus metus. Suspendisse vel mi a lacus finibus vehicula vel ut
            diam. Nam pellentesque, mi quis ullamcorper.
          </p>
        </div>
      </div>
    </>
